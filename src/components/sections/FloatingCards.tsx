  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "5px" }}>
          <div
            style={{
              ...
              border: "1px solid rgba(203,133,48,0.3)",
          ...
          >
            <div
              style={{
                width: "70px",
                height: "6px",
                background: "rgba(203,133,48,0.5)",
                borderRadius: "3px",
              }}
            />
          </div>
          <div
            style={{
              ...
              border: "1px solid rgba(240,239,231,0.1)",
          ...
          >
            <div
              style={{
                width: "55px",
                height: "6px",
                background: "rgba(240,239,231,0.25)",
                borderRadius: "3px",
              }}
            />
          </div>
        ...
        >
          <span style={{ fontSize: "9px", color: "rgba(240,239,231,0.45)" }}>
            Response rate
          </span>
          <span style={{ fontSize: "11px", fontWeight: 700, color: "#cb8530" }}>
            97%
          </span>
        </div>
      </div>
      ...
      >
        ...
        {/* Pipeline flow */}
        {["Ad Campaign", "Landing Page", "Lead Capture", "Booked Call"].map(
          (step, i) => (
            <div
              key={step}
              style={{
            ...
            >
              ...
              <span
                style={{
                  fontSize: "9px",
                  color: i === 3 ? "#F0EFE7" : "rgba(240,239,231,0.5)",
                }}
              >
                {step}
              </span>
      ...
      >
        ...
        >
          <div>
            <div
              style={{ fontSize: "13px", fontWeight: 700, color: "#cb8530" }}
            >
              $24
            </div>
            <div style={{ fontSize: "8px", color: "rgba(240,239,231,0.4)" }}>
              Cost/Lead
            </div>
          </div>
          <div style={{ textAlign: "right" }}>
            <div
              style={{ fontSize: "13px", fontWeight: 700, color: "#F0EFE7" }}
            >
              312
            </div>
            <div style={{ fontSize: "8px", color: "rgba(240,239,231,0.4)" }}>
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "5px" }}>
          {[
            ...
            >
              <span style={{ fontSize: "8px", color: "#cb8530" }}>
                {item.icon}
              </span>
              <span
                style={{
                  fontSize: "10px",
                  color: "rgba(240,239,231,0.75)",
                  fontWeight: 500,
                }}
              >
                {item.label}
        ...
        <div
          style={{
            marginTop: "8px",
            textAlign: "center",
            background: "rgba(203,133,48,0.1)",
            border: "1px solid rgba(203,133,48,0.25)",
            borderRadius: "999px",
            padding: "3px 8px",
          }}
