...
const slides = [
  ...
  },
  {
    id: 2,
    title: "AI\nFollow-Up",
    description: "Someone scrolls past your ad at midnight — by morning they're confirmed on your calendar without you lifting a finger.",
  ...
  },
  {
    id: 4,
    title: "Qualified\nLead Systems",
    description: "Pre-qualified patients with genuine interest and financial capacity delivered to your calendar — every lead serious and ready to commit.",
    ...
    const init = async () => {
      ...
      slideEls.forEach((slide) => {
        ...
        tl.from(slide.querySelectorAll(".mech-slide-title"), {
          ...
          .from(slide.querySelectorAll(".mech-line-inner"), {
            y: 200,
            duration: 2,
            ease: "power4",
            stagger: 0.1,
          }, 0)
          .from(slide.querySelectorAll(".mech-slide-desc"), {
            x: 80,
            y: 40,
            opacity: 0,
            duration: 2,
  ...
  return (
    <div id="mech-smooth-wrapper" style={{ overflow: "hidden" }}>
      <div ref={stageRef} style={{ background: "#0b0d11" }}>
        ...
        >
          {/* Heading */}
          <div className="text-center mb-12 sm:mb-16 absolute top-1/3 left-1/2"
...
>
  ...
  >
    The Creavox Patient<br />Acquisition System
  </p>
